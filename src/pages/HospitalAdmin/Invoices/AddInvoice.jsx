...
const AddInvoice = () => {
  ...
  const handleSubmit = (values) => {
    console.log(isEditing ? 'Updating invoice:' : 'Creating new invoice:', values)
    // Here you would typically make an API call to save/update invoice
    setShowSuccessModal(true)
  }

  const handleSuccessModalClose = () => {
    setShowSuccessModal(false)
    navigate('/hospital-admin/invoices')
  }
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-5 gap-4'>
                            <div className='md:col-span-2'>
                              <Select
                                ...
                                onChange={(e) => {
                                  handleChange(e)
                                  const selectedService = commonServices.find(s => s.value === e.target.value)
                                  if (selectedService) {
                                    setFieldValue(`services.${index}.unitPrice`, selectedService.price)
                                    setFieldValue(`services.${index}.amount`, service.quantity * selectedService.price)
                                  }
                                }}
                                onBlur={handleBlur}
                                error={
                            ...
                            <div>
                              <Input
                                ...
                                onChange={(e) => {
                                  handleChange(e)
                                  setFieldValue(`services.${index}.amount`, e.target.value * service.unitPrice)
                                }}
                                onBlur={handleBlur}
                                error={
                            ...
                            <div>
                              <Input
                                ...
                                onChange={(e) => {
                                  handleChange(e)
                                  setFieldValue(`services.${index}.amount`, service.quantity * parseFloat(e.target.value || 0))
                                }}
                                onBlur={handleBlur}
                                error={
          ...
          <div className='bg-white rounded-lg p-6 max-w-md w-full mx-4'>
            ...
            <p className='text-slate-600 text-center mb-6'>
              {isEditing
                ...
                : 'The new invoice has been created and is ready to be sent to the patient.'}
            </p>
