    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div>
                ...
                <p className="text-slate-500 mt-1">Manage your system administrator profile and security settings.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-1 space-y-6">
                    <div className="bg-white border border-slate-200 rounded-2xl p-6 text-center shadow-sm">
                        ...
                        <p className="text-xs font-semibold text-teal-600 bg-teal-50 px-2 py-1 rounded-full uppercase inline-block mt-2 tracking-wider">Super Administrator</p>
                    </div>
                    ...
                    <nav className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                        {[
                            ...
                            return (
                                <button key={idx} className={`w-full flex items-center gap-3 px-6 py-4 text-sm font-medium transition-colors ${item.active ? "bg-teal-50 text-teal-700 border-r-4 border-teal-600" : "text-slate-600 hover:bg-slate-50"
                                    }`}>
                ...
                <div className="md:col-span-2">
                    <div className="bg-white border border-slate-200 rounded-2xl shadow-sm">
                        <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                            ...
                            <button className="text-sm font-semibold text-teal-600 hover:text-teal-700">Edit Details</button>
                        </div>
                        <div className="p-8">
                                ...
                                <Form className="space-y-6">
                                    ...
                                    <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
                                        <div className="flex items-center gap-2 text-slate-500">
                                            ...
                                            <span className="text-xs font-medium">Last password change: Jan 12, 2026</span>
                                        </div>
                                        <button type="submit" className="bg-teal-600 text-white px-6 py-2 rounded-lg font-bold shadow-teal-600/20 shadow-lg hover:bg-teal-700 transition-colors">
                                            Save Changes
                                        </button>
                                    </div>
                                </Form>
                    ...
                    <div className="mt-8 bg-red-50 border border-red-200 rounded-2xl p-6 flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-red-700 mt-1">For maximum security, SuperAdmin accounts are required to have 2FA enabled at all times. Please verify your authentication device regularly.</p>
                        </div>
                    </div>
                </div>
            </div>
