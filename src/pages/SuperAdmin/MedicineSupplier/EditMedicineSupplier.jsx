    ...
    if (!supplier) {
        return (
            <div className="flex flex-col items-center justify-center py-24 text-slate-400">
                ...
                <button onClick={() => navigate(-1)} className="mt-4 text-sm text-teal-600 font-semibold hover:underline">
                    ← Go back
                </button>
            </div>
        );
    ...
    return (
        <div className="bg-white">
            ...
            <div className="px-8 pt-6 pb-0 border-b border-slate-100 flex items-center gap-3">
                ...
                <h2 className="text-sm font-bold text-slate-800">Editing: <span className="text-teal-600">{supplier.name}</span></h2>
            </div>
                        ...
                        <Form className="space-y-8 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            {step === 1 && (
                                <section className="space-y-6">
                                    ...
                                    <div className="p-6 bg-slate-50 border border-dashed border-slate-300 rounded-2xl flex flex-col items-center text-center">
                                        ...
                                        <p className="text-xs text-slate-500 max-w-xs mt-1">Select the exact warehouse / HQ location on the map for accurate GPS routing.</p>
                            ...
                            {step === 2 && (
                                <section className="space-y-6">
                                    ...
                                    <p className="text-sm text-slate-500">Select the platform documents you wish to share with this medical supplier.</p>
                                        ...
                                        {docsList.map((doc) => (
                                            <div key={doc.id} className="p-4 rounded-2xl border border-slate-200 hover:border-teal-500 hover:bg-teal-50/20 transition-all cursor-pointer group">
                                                <div className="flex items-start gap-4">
                                                    <div className="mt-1"><Checkbox name={doc.id} /></div>
                                    ...
                                    <div className="p-4 bg-blue-50 rounded-xl border border-blue-100 flex gap-3">
                                        ...
                                        <p className="text-xs text-blue-800 font-medium">Selected documents will be available in the Supplier's dashboard after activation.</p>
                                    </div>
                                </section>
                            )}
                                ...
                                <section className="space-y-6">
                                    ...
                                    <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 space-y-4">
                                        ...
                                        <p className="text-sm text-slate-600 mb-4">
                                            By checking the boxes below, you confirm the updated information is accurate and this supplier meets all compliance requirements.
                                        </p>
