...
const initialSuppliers = [
    { id: 1, name: "PharmaLink Solutions", location: "New Jersey, US", inventory: "5,000+ SKUs", status: "Active", compliance: "Certified" },
    { id: 2, name: "BioLogistics Intl", location: "Berlin, DE", inventory: "2,500+ SKUs", status: "Active", compliance: "Verified" },
    { id: 3, name: "Apex Medical Dist.", location: "Mumbai, IN", inventory: "8,000+ SKUs", status: "Inactive", compliance: "Pending" },
];
...
const StatusModal = ({ supplier, isDeactivating, onClose, onConfirm }) => {
    ...
    const deactivatePresets = ["License expired", "Non-compliance", "Contract terminated", "Under review"];
    const activatePresets = ["License renewed", "Compliance restored", "New contract signed", "Review completed"];
            ...
            <div className="bg-white rounded-2xl shadow-2xl border border-slate-100 w-full max-w-md mx-4 overflow-hidden">
                ...
                <div className="px-6 py-5 space-y-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <textarea
                            ...
                            rows={3}
                            className={`w-full px-3 py-2.5 text-sm text-slate-800 bg-slate-50 border rounded-xl focus:outline-none focus:ring-2 resize-none transition-all ${isDeactivating
                ...
                <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-end gap-3">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-5 py-2 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-bold rounded-xl transition-colors ${isDeactivating
            ...
            render: (row) => (
                <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg transition-colors ${row.status === "Active"
