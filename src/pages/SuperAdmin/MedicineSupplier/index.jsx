    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-black text-slate-800 tracking-tight text-text-main">Medicine Supplier Management</h1>
                    <p className="text-slate-500 font-medium text-sm mt-1 text-text-muted">Manage pharmaceutical supply chains and distributor relationships.</p>
                </div>
            </div>
            ...
            <div className="flex gap-4 border-b border-slate-200">
                {[
                    ...
                    const Icon = tab.icon;
                    const isActive = location.pathname.endsWith(`/suppliers/${tab.id}`) ||
                    ...
                    return (
                        ...
                        >
                            ...
                            {tab.label}
                            {tab.id === "requests" && (
                                <span className="ml-1 px-1.5 py-0.5 bg-primary-light text-primary rounded-full text-[10px]">5</span>
                            )}
                        </NavLink>
                    );
                })}
