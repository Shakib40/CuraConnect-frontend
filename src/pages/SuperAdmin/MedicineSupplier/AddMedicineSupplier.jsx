                ...
                <section className='space-y-6'>
                  ...
                  <div className='p-6 bg-slate-50 border border-dashed border-slate-300 rounded-2xl flex flex-col items-center text-center'>
                    ...
                    <p className='text-xs text-slate-500 max-w-xs mt-1'>
                      Select your exact warehouse / HQ location on the map for accurate GPS routing.
                    </p>
                    <button
                      type='button'
                ...
                <section className='space-y-6'>
                  ...
                  <div className='p-4 bg-blue-50 rounded-xl border border-blue-100 flex gap-3'>
                    ...
                    <p className='text-xs text-blue-800 font-medium'>
                      Selected documents will be available for download in the Supplier's dashboard
                ...
                <section className='space-y-6'>
                  ...
                  <div className='bg-slate-50 p-6 rounded-2xl border border-slate-200 space-y-4'>
                    ...
                    <p className='text-sm text-slate-600 mb-4'>
                      By checking the boxes below, you confirm that all information provided is
                      accurate and you understand that new suppliers undergo a rigorous background
                      check involving license verification and quality compliance audits.
                    </p>
                    <Checkbox
                      name='acceptTerms'
      ...
      <div className='flex items-center gap-4 p-8 bg-slate-50 border-t border-slate-100'>
        ...
        <div>
          ...
          <p className='text-xs text-text-muted mt-1 leading-relaxed max-w-2xl'>
            All new suppliers undergo a rigorous background check involving license verification and
            quality compliance audits. This process typically takes 3-5 business days.
          </p>
        </div>
      </div>
    </div>
