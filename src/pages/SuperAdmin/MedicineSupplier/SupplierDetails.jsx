        ...
        <div className="bg-white">
            ...
            <div className="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1 flex-wrap">
                            <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${supplier.status === "Active" ? "bg-green-100 text-green-700" : "bg-slate-100 text-slate-500"
                                }`}>
                                <div className={`w-1.5 h-1.5 rounded-full ${supplier.status === "Active" ? "bg-green-500" : "bg-slate-400"}`} />
                                {supplier.status}
                            </span>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button icon={Pencil} onClick={() => navigate(`/superadmin/suppliers/${supplier.id}/edit`)}>
                        Edit Supplier
                    </Button>
                </div>
            </div>
            ...
            <div className="p-6 lg:p-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4 p-6 bg-slate-50 rounded-2xl border border-slate-100">
                    ...
                    <InfoRow icon={Truck} label="Business Model" value={supplyTypeLabel[supplier.supplyType]} />
                </div>
                ...
                <div className="space-y-4 p-6 bg-slate-50 rounded-2xl border border-slate-100">
                    ...
                    <div className="space-y-2">
                        {docs.map((doc) => (
                            <div key={doc.id} className="flex items-center gap-3 py-2 border-b border-slate-100 last:border-0">
                                ...
                                <span className={`text-sm font-medium ${supplier[doc.id] ? "text-slate-800" : "text-slate-400"}`}>
                                    {doc.label}
                                </span>
                    ...
                    <div className="p-3 bg-blue-50 rounded-xl border border-blue-100 flex gap-2">
                        ...
                        <p className="text-[11px] text-blue-800 font-medium">Checked documents are shared with this supplier's dashboard.</p>
                    </div>
                </div>
            </div>
        </div>
