...
const ChatPage = () => {
  ...
  const [chats, setChats] = useState([
    {
      ...
      entityId: 'HOS001',
      lastMessage:
        'Thank you for processing our insurance claim quickly. The reimbursement has been processed.',
      timestamp: '2024-01-23T14:30:00Z',
      unreadCount: 2,
      status: 'online',
      avatar:
        'https://ui-avatars.com/api/?name=City+General+Hospital&background=random&color=7f9cf5',
      messages: [
        {
          id: 1,
          sender: 'hospital',
        ...
        },
        {
          ...
          sender: 'hospital',
          content:
            'We need to add coverage for telemedicine services and update our provider network.',
        ...
        },
        {
          ...
          sender: 'admin',
          content:
            "I'll prepare the necessary documentation and send you the updated policy terms by end of day.",
    ...
    },
    {
      ...
      entityId: 'SUP001',
      lastMessage:
        'The new shipment of medical supplies has been dispatched. Expected delivery by Friday.',
      timestamp: '2024-01-23T13:45:00Z',
      unreadCount: 1,
      status: 'online',
      avatar:
        'https://ui-avatars.com/api/?name=MediCare+Pharmaceuticals&background=random&color=8b5cf6',
      messages: [
        {
          id: 1,
          sender: 'supplier',
        ...
        },
        {
          ...
          sender: 'admin',
          content:
            "Absolutely! I'll check the inventory and arrange priority shipping for tomorrow.",
        ...
        },
        {
          ...
          sender: 'admin',
          content:
            "I'll send over the new contract proposal by EOD. The new shipment has been dispatched and should arrive by Friday.",
          timestamp: '2024-01-23T13:45:00Z',
          status: 'sent',
        },
      ],
    },
    {
      ...
      status: 'offline',
      avatar:
        'https://ui-avatars.com/api/?name=Metro+Medical+Center&background=random&color=10b981',
      messages: [
        {
          id: 1,
          sender: 'hospital',
          content:
            "We've completed the quarterly compliance report. Please review and provide feedback.",
        ...
        },
        {
          ...
          sender: 'admin',
          content:
            "Great work! The report looks comprehensive. I'll approve it and share with the compliance team.",
    ...
    },
    {
      ...
      status: 'online',
      avatar:
        'https://ui-avatars.com/api/?name=HealthPlus+Distributors&background=random&color=6366f1',
      messages: [
        {
          id: 1,
          sender: 'supplier',
  ...
  const filteredChats = chats.filter((chat) => {
    const matchesSearch =
      chat.entityName.toLowerCase().includes(searchTerm.toLowerCase()) ||
            ...
            >
              <div className='flex items-start gap-3'>
                <div className='relative'>
                  ...
                  />
                  <div className='absolute bottom-0 right-0'>{getStatusIndicator(chat.status)}</div>
                </div>
        ...
        <div className='flex-1 flex flex-col bg-white'>
          ...
          <div className='flex-1 overflow-y-auto p-4 space-y-4'>
            {selectedChat.messages?.map((msg) => (
              ...
              >
                <div
                  className={`max-w-xs lg:max-w-md ${msg.sender === 'admin' ? 'order-2' : 'order-1'}`}
                >
                  <div
                    className={`flex items-end gap-2 ${msg.sender === 'admin' ? 'flex-row-reverse' : 'flex-row'}`}
                  >
                    {msg.sender !== 'admin' && (
                      <img
                        src={selectedChat.avatar}
                    ...
                    >
                      ...
                      <div
                        className={`text-xs mt-1 ${msg.sender === 'admin' ? 'text-primary/70 text-right' : 'text-slate-500'}`}
                      >
