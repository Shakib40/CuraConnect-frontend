...
const docsList = [
    ...
    { id: "shareTax", label: "Income Tax Returns (Latest)", desc: "Financial transparency for providers." },
                        ...
                        <Form className="space-y-8 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
                            ...
                            {step === 0 && (
                                <section className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <Input name="licenseNo" label="Insurance License No." placeholder="e.g. IRDAI-00123-2024" icon={Shield} />
                            ...
                            {step === 1 && (
                                <section className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="md:col-span-2">
                                            <Input name="street" label="Street Name / Number" placeholder="123 Insurance Ave" icon={MapPin} />
                                        </div>
                            ...
                            {step === 2 && (
                                <section className="space-y-6">
                                    ...
                                    <div className="p-4 bg-blue-50 rounded-xl border border-blue-100 flex gap-3">
                                        ...
                                        <p className="text-xs text-blue-800 font-medium">Selected documents will be available in the Provider's dashboard after activation.</p>
                                    </div>
                                </section>
                            )}
