    ...
    <div className='bg-white'>
      ...
      <div className='px-8 pt-6 pb-0 border-b border-slate-100 flex items-center gap-3'>
        ...
        <h2 className='text-sm font-bold text-slate-800'>
          Editing: <span className='text-teal-600'>{provider.name}</span>
        </h2>
      </div>
                ...
                <section className='space-y-6'>
                  ...
                  <div className='p-6 bg-slate-50 border border-dashed border-slate-300 rounded-2xl flex flex-col items-center text-center'>
                    ...
                    <p className='text-xs text-slate-500 max-w-xs mt-1'>
                      Select the exact HQ location on the map for GPS accuracy.
                    </p>
                    <button
                      type='button'
              ...
              {step === 2 && (
                <section className='space-y-6'>
                  ...
                  <p className='text-sm text-slate-500'>
                    Select the platform documents to share with this insurance provider.
                  </p>
                ...
                <section className='space-y-6'>
                  ...
                  <div className='bg-slate-50 p-6 rounded-2xl border border-slate-200 space-y-4'>
                    ...
                    <p className='text-sm text-slate-600 mb-4'>
                      ...
                      and meets all platform compliance requirements.
                    </p>
                    <Checkbox
                      name='acceptTerms'
