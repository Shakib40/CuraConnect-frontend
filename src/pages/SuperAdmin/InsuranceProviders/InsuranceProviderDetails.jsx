...
const mockProviders = [
  {
    id: 1,
    name: 'BlueCross Core',
    licenseNo: 'IRDAI-00123-2024',
    planType: 'global',
    email: 'ops@bc-core.com',
    phone: '+1 (312) 555-0100',
    website: 'https://www.bc-core.com',
  ...
  },
  {
    ...
    licenseNo: 'IRDAI-00456-2024',
    planType: 'regional',
    email: 'contact@healthlink.io',
    phone: '+1 (512) 555-0200',
    website: 'https://www.healthlink.io',
    street: '456 Health Blvd',
    road: 'Near Congress Ave',
    city: 'Austin',
    state: 'Texas',
    pincode: '78701',
    country: 'United States',
  ...
  },
  {
    id: 3,
    name: 'SafeGuard Ltd',
    licenseNo: 'IRDAI-00789-2024',
    planType: 'specialized',
    email: 'info@safeguard-health.com',
    phone: '+1 (305) 555-0300',
    website: 'https://www.safeguard-health.com',
    street: '789 Safety Lane',
    road: 'Near Brickell',
    city: 'Miami',
    state: 'Florida',
    pincode: '33101',
    ...
    <div className='bg-white'>
      ...
      <div className='p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4'>
        <div className='flex items-center gap-4'>
          ...
          <div>
            ...
            <div className='flex items-center gap-2 mt-1 flex-wrap'>
              ...
              >
                <div
                  className={`w-1.5 h-1.5 rounded-full ${provider.status === 'Active' ? 'bg-green-500' : 'bg-slate-400'}`}
                />
                {provider.status}
              </span>
        ...
        <div className='flex items-center gap-3'>
          ...
          <Button
            icon={Pencil}
            onClick={() => navigate(`/superadmin/insurance/${provider.id}/edit`)}
          >
            Edit Provider
          </Button>
        </div>
      ...
      <div className='p-6 lg:p-8 grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        <div className='space-y-4 p-6 bg-slate-50 rounded-2xl border border-slate-100'>
          ...
          <InfoRow
            ...
            value={planTypeLabel[provider.planType]}
          />
        ...
        <div className='space-y-4 p-6 bg-slate-50 rounded-2xl border border-slate-100'>
          ...
          <div className='space-y-2'>
            {docs.map((doc) => (
              ...
              >
                ...
                <span
                  className={`text-sm font-medium ${provider[doc.id] ? 'text-slate-800' : 'text-slate-400'}`}
                >
                  {doc.label}
                </span>
          ...
          <div className='p-3 bg-blue-50 rounded-xl border border-blue-100 flex gap-2'>
            ...
            <p className='text-[11px] text-blue-800 font-medium'>
              Checked documents are shared with this provider's dashboard.
            </p>
          </div>
        </div>
      </div>
