...
import { Search, Filter, Calendar, User, Building2, Truck, ShieldCheck, Activity, Clock, CheckCircle, XCircle, AlertCircle } from "lucide-react";
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 font-medium text-sm mt-1">Monitor all system activities across entities.</p>
                </div>
            </div>
                                ...
                                <tr key={activity.id} className="border-b border-slate-100 hover:bg-slate-50">
                                    ...
                                    <td className="py-3 px-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm font-medium text-slate-800 capitalize">{activity.entity}</span>
                                        </div>
                                    </td>
                                    <td className="py-3 px-4">
                                        <div>
                                            <div className="text-sm font-medium text-slate-800">{activity.entityName}</div>
                                            <div className="text-xs text-slate-500">ID: {activity.entityId}</div>
                                        </div>
                                    </td>
                                    <td className="py-3 px-4">
                                        <span className="text-sm text-slate-600 capitalize">{activity.action.replace('_', ' ')}</span>
                                    </td>
                                    <td className="py-3 px-4">
