...
import { Search, Filter, Calendar, FileText, AlertTriangle, CheckCircle, Clock, User, Building2, Truck, ShieldCheck, Eye, MessageSquare, Download, MoreVertical, ChevronDown } from "lucide-react";
...
const CasesPage = () => {
    ...
    const cases = useMemo(() => [
        // Hospital cases
        {
            ...
            description: "Patient John Smith's insurance claim has been pending for over 48 hours without processing.",
            category: "Insurance",
            priority: "high",
            status: "pending",
            severity: "medium",
        ...
        },
        {
            ...
            description: "Emergency medical supplies delivery delayed by 48 hours due to logistics issues.",
            category: "Logistics",
            priority: "high",
            status: "in-progress",
            severity: "medium",
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 font-medium text-sm mt-1">Track and manage cases from all entities.</p>
                </div>
            </div>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-slate-200 bg-slate-50">
                                <th className="text-left py-3 px-4 font-semibold text-slate-700 text-sm">Case ID</th>
                                ...
                                <th className="text-left py-3 px-4 font-semibold text-slate-700 text-sm">Raised By</th>
                        ...
                        <tbody>
                            {filteredCases.map((caseItem) => (
                                <tr key={caseItem.id} className="border-b border-slate-100 hover:bg-slate-50">
                                    ...
                                    <td className="py-3 px-4">
                                        <span className="text-sm text-slate-600">{formatDate(caseItem.raisedDate)}</span>
                                    </td>
                                    <td className="py-3 px-4">
                                        <div className="flex items-center gap-2">
