...
const InsuranceProviderDocuments = () => {
  const [searchTerm, setSearchTerm] = useState('')
  const [selectedStatus, setSelectedStatus] = useState('all')

  // Mock data for insurance provider documents
  const documents = [
    {
      id: 1,
      name: 'IRDAI Registration Certificate',
      type: 'Legal Document',
      status: 'verified',
    ...
    {
      id: 6,
      name: 'Network Hospital Agreement',
      type: 'Legal Document',
      status: 'expired',
  ...
  return (
    <div className='p-6'>
      <div className='mb-6'>
        <h2 className='text-xl font-semibold text-slate-800 mb-2'>Insurance Provider Documents</h2>
        <p className='text-slate-600 text-sm'>
          List of compliance and legal documents required for insurance provider onboarding process
        </p>
      </div>
...
export default InsuranceProviderDocuments
