  ...
  const notifications = useMemo(
    () => [
      // System notifications
      {
        ...
        description:
          'System maintenance is scheduled for tonight from 2:00 AM to 4:00 AM EST. Services may be temporarily unavailable.',
      ...
      },
      {
        ...
        description:
          'Advanced analytics dashboard is now available. Check your dashboard for new insights and reporting features.',
      ...
      // Supplier notifications
      {
        ...
        title: 'Quality Alert',
        description:
          'MediCare Pharmaceuticals batch #12345 failed quality inspection. Immediate action required.',
      ...
      // Insurance notifications
      {
        ...
        description:
          'Multiple insurance claims from HealthGuard are pending processing beyond SLA.',
      ...
      // Case notifications
      {
        ...
        description:
          'Case CASE-2024-004 has been escalated to priority support due to quality control issues.',
      ...
      <div className='flex flex-col md:flex-row md:items-center justify-between gap-4'>
        <div>
          ...
          <p className='text-slate-500 font-medium text-sm mt-1'>
            Stay updated with all system and entity activities.
          </p>
        </div>
      </div>
                ...
                <div className='flex-1 min-w-0'>
                  <div className='flex items-center justify-between mb-2'>
                    <div className='flex items-center gap-2'>
                      ...
                      <span
                        className={`inline-flex px-2 py-1 text-xs font-medium rounded-full border ${getPriorityColor(notification.priority)}`}
                      >
