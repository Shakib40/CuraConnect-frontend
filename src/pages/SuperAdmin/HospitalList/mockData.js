export const initialHospitals = [
  ...
  },
  {
    ...
    type: 'private',
    email: 'info@sunsetclinic.org',
    phone: '+1 (310) 555-0202',
    website: 'https://sunsetclinic.org',
    street: '8 Sunset Blvd',
    city: 'Los Angeles',
    state: 'CA',
    pincode: '90001',
    country: 'United States',
  ...
  },
  {
    ...
    type: 'government',
    email: 'care@wellnesscenter.net',
    phone: '+1 (312) 555-0303',
    website: 'https://wellnesscenter.net',
    street: '500 Wellness Ave',
    city: 'Chicago',
    state: 'IL',
    pincode: '60601',
    country: 'United States',
...
export const initialRequests = [
  {
    ...
    location: 'Boston, MA',
    contact: 'admin@stmarys.com',
    date: '2026-02-20',
    phone: '+1 (617) 555-0401',
    type: 'Private',
    message:
      "St. Mary's Medical is seeking to onboard CuraConnect to manage its 1,200+ bed facility and streamline patient records.",
    signedDocs: [
  ...
  },
  {
    ...
    location: 'Seattle, WA',
    contact: 'info@northside.org',
    date: '2026-02-21',
    phone: '+1 (206) 555-0502',
    type: 'Government',
    message:
      'Northside Health is a publicly funded hospital aiming to digitise patient workflows via CuraConnect.',
    signedDocs: [
