...
import { Building2, MapPin, FileText, Shield, Info, CheckCircle, ArrowLeft } from 'lucide-react'
                  ...
                  <div className='space-y-6'>
                    ...
                    <div className='p-6 bg-slate-50 border border-dashed border-slate-300 rounded-2xl flex flex-col items-center text-center'>
                      ...
                      <p className='text-xs text-slate-500 max-w-xs mt-1'>
                        Pin your exact location for GPS navigation accuracy.
                      </p>
                      <button
                        type='button'
                ...
                {step === 2 && (
                  <div className='space-y-6'>
                    ...
                    <p className='text-sm text-slate-500'>
                      Select the platform documents you wish to share with this hospital during
                      ...
                      {[
                        {
                          ...
                          desc: 'Standard tax compliance document for Indian operations.',
                        },
                        {
                          id: 'shareLegal',
                          label: 'Operating License & Legal Charter',
                          desc: 'Proof of authority to provide healthcare platform services.',
                        },
                        {
                          id: 'shareTax',
                          label: 'Income Tax Returns (Latest)',
                          desc: 'Financial transparency for enterprise-level hospitals.',
                        },
                        {
                          id: 'shareBusiness',
                    ...
                    <div className='p-4 bg-blue-50 rounded-xl border border-blue-100 flex gap-3'>
                      ...
                      <p className='text-xs text-blue-800 font-medium'>
                        Selected documents will be available for download in the Hospital's
                        dashboard immediately after account activation.
                      </p>
                    </div>
                  </div>
                )}
