        ...
        <div className="bg-white">
            {isEdit && (
                <div className="px-8 pt-6 pb-0 border-b border-slate-100 flex items-center gap-3">
                    <button onClick={() => navigate(`/superadmin/hospitals/${id}`)}
            ...
            <RegistrationWizard
                ...
                onComplete={() => navigate(isEdit ? `/superadmin/hospitals/${id}` : "/superadmin/hospitals/list")}
                onCancel={() => navigate(isEdit ? `/superadmin/hospitals/${id}` : "/superadmin/hospitals/list")}
            />
        </div>
    );
};
