...
const HospitalManagement = () => {
    ...
    const hideTabs = location.pathname.includes("/hospitals/") &&
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 font-medium text-sm mt-1">Manage platform participants and subscriptions.</p>
                </div>
            </div>
