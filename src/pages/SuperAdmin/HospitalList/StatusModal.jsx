                ...
                <div className="px-6 py-5 space-y-4">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <textarea
                            ...
                            className={`w-full px-3 py-2.5 text-sm bg-slate-50 border rounded-xl focus:outline-none focus:ring-2 resize-none transition-all border-slate-200 ${isDeactivating ? "focus:ring-red-300 focus:border-red-400" : "focus:ring-green-300 focus:border-green-400"
                                }`}
                        />
