...
const Dashboard = () => {
    ...
    const stats = [
        ...
        { label: "Medicine Suppliers", value: "86", icon: Truck, color: "text-purple-600", bg: "bg-purple-50" },
        { label: "Total Patients", value: "12,450", icon: Users, color: "text-green-600", bg: "bg-green-50" },
