...
import { Search, Filter, Plus, Edit, Trash2, Tag, Users, Building2, Truck, Gift, Percent, Calendar, CheckCircle, AlertTriangle, Clock, DollarSign, Target, Package, Star } from "lucide-react";
...
const OfferPage = () => {
    ...
    const offers = useMemo(() => [
        // Patient offers
        {
            ...
            description: "Special discount for annual health checkup package. Includes comprehensive blood work, ECG, and consultation.",
            type: "discount",
        ...
        },
        {
            ...
            description: "First telemedicine consultation completely free for new patients. Limited to first 50 sign-ups.",
            type: "free_service",
            discountValue: 100,
        ...
        // Hospital offers
        {
            ...
            description: "Bulk purchase discount on medical equipment and supplies for hospitals. Minimum order $10,000 required.",
            type: "discount",
            discountType: "percentage",
            discountValue: 15,
        ...
        },
        {
            ...
            description: "Complimentary EMR software setup and training for new hospital partners. Includes 6 months support.",
            type: "free_service",
            discountValue: 0,
        ...
        // Medicine Supplier offers
        {
            ...
            description: "Quarterly bulk order discount for pharmaceutical supplies. Free shipping on orders over $5,000.",
            type: "discount",
            discountType: "percentage",
            discountValue: 25,
            validUntil: "2024-03-31T23:59:59Z",
        ...
        },
        {
            ...
            description: "Free quality certification service for first-time suppliers. Includes compliance documentation.",
            type: "free_service",
            discountValue: 0,
            validUntil: "2024-02-28T23:59:59Z",
            status: "active",
        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-slate-500 font-medium text-sm mt-1">Manage discounts and special offers for all entities.</p>
                </div>
                <button
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-slate-200 bg-slate-50">
                                ...
                                <th className="text-left py-3 px-4 font-semibold text-slate-700 text-sm">Entity Name</th>
                                ...
                                <th className="text-left py-3 px-4 font-semibold text-slate-700 text-sm">Discount/Value</th>
                                <th className="text-left py-3 px-4 font-semibold text-slate-700 text-sm">Status</th>
                                <th className="text-left py-3 px-4 font-semibold text-slate-700 text-sm">Valid Until</th>
                                ...
                                <tr key={offer.id} className="border-b border-slate-100 hover:bg-slate-50">
                                    <td className="py-3 px-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm font-medium text-slate-800 capitalize">{offer.entity}</span>
                                        </div>
                                    </td>
                                    <td className="py-3 px-4">
                                        <div>
                                    ...
                                    <td className="py-3 px-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm text-slate-600 capitalize">{offer.type.replace('_', ' ')}</span>
                                        </div>
                                    </td>
                                    <td className="py-3 px-4">
                                        <span className={`font-semibold ${offer.type === 'free_service' ? 'text-green-600' : 'text-blue-600'}`}>
                    ...
                    <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
                        ...
                        <div className="p-6 overflow-y-auto max-h-[70vh]">
                            <div className="space-y-4">
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 mb-2">Entity Name/ID</label>
                                    <input
                                        type="text"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            type="date"
                                            defaultValue={editingOffer?.validUntil ? editingOffer.validUntil.split('T')[0] : ''}
                                            className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                                        />
                                    </div>
