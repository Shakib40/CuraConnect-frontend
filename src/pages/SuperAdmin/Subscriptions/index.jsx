...
const plans = [
    {
        ...
        features: ["Up to 10 staff users", "Core appointment system", "Basic health records", "Email notifications"],
        color: "bg-slate-50",
    ...
    },
    {
        ...
        features: ["Up to 50 staff users", "Advanced clinical records", "Lab & Pharmacy modules", "SMS & Email notifications", "Custom reports"],
        color: "bg-teal-50",
    ...
    },
    {
        ...
        features: ["Unlimited staff users", "Multi-branch support", "API Access & Integrations", "Dedicated support manager", "White-label options"],
        color: "bg-purple-50",
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {plans.map((plan, idx) => (
                    <div key={idx} className={`relative rounded-3xl border-2 ${plan.border} ${plan.color} p-8 flex flex-col shadow-sm`}>
                        {plan.popular && (
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex items-baseline gap-1 mt-2">
                                ...
                                {plan.price !== "Custom" && <span className="text-slate-500 text-sm">/per month</span>}
                            </div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-dashed border-slate-300 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500">Contact the product team for enterprise custom billing adjustments.</p>
                    </div>
                </div>
