                  ...
                  <div className='space-y-3'>
                    ...
                    {!personalInfo.isEmailVerified && personalInfo.email && !errors.email && (
                      <p className='text-xs text-slate-500'>
                        Click "Verify" to send a confirmation email
                      </p>
                    )}
                  </div>
                ) : (
            ...
            <div className='space-y-4'>
              <div className='border-2 border-dashed border-slate-300 rounded-lg p-6'>
                <div className='text-center'>
                  ...
                  <p className='text-xs text-slate-500 mb-4'>
                    Do you have a valid Aadhar card for identity verification?
                  </p>
                    ...
                    <>
                      {uploadProgress.aadhar !== undefined ? (
                        <div className='space-y-3'>
                          ...
                          <p className='text-xs text-slate-500'>
                            Uploading... {uploadProgress.aadhar}%
                          </p>
                        </div>
                      ) : (
                        <>
              ...
              <div className='border-2 border-dashed border-slate-300 rounded-lg p-6'>
                <div className='text-center'>
                  ...
                  <p className='text-xs text-slate-500 mb-4'>
                    Do you have a recent passport-sized photograph?
                  </p>
                  <input
                    type='file'
                    accept='image/*'
              ...
              <div className='border-2 border-dashed border-slate-300 rounded-lg p-6'>
                <div className='text-center'>
                  ...
                  <p className='text-xs text-slate-500 mb-4'>
                    Do you have a PAN card for tax identification?
                  </p>
                  <input
                    type='file'
                    accept='image/*'
        ...
        return (
          <div className='space-y-6'>
            ...
            <p className='text-sm text-slate-600 mb-6'>
              Do you have your bank account details for payments?
            </p>
            ...
            <div className='space-y-4'>
              ...
              <div className='border-2 border-dashed border-slate-300 rounded-lg p-6'>
                <div className='text-center'>
                  ...
                  <p className='text-xs text-slate-500 mb-4'>
                    Upload bank statement or cancelled cheque for verification
                  </p>
                  <input
                    type='file'
                    accept='.pdf,.jpg,.png'
                    onChange={handleFileUpload('bankDetails')}
                    className='hidden'
                    id='bank-upload'
                  />
                  <label
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div className='border-2 border-dashed border-slate-300 rounded-lg p-6'>
                <div className='text-center'>
                  ...
                  <p className='text-xs text-slate-500 mb-4'>
                    Do you have a valid medical practitioner license?
                  </p>
                  <input
                    type='file'
                    accept='.pdf,.jpg,.png'
                    onChange={handleFileUpload('medicalLicense')}
                    className='hidden'
                    id='medical-upload'
                  />
                  <label
              ...
              <div className='border-2 border-dashed border-slate-300 rounded-lg p-6'>
                <div className='text-center'>
                  ...
                  <p className='text-xs text-slate-500 mb-4'>
                    Do you have pharmacy operation certificates?
                  </p>
                  <input
                    type='file'
                    accept='.pdf,.jpg,.png'
                    onChange={handleFileUpload('pharmacyCertificate')}
                    className='hidden'
                    id='pharmacy-upload'
                  />
                  <label
                    htmlFor='pharmacy-upload'
                    className='cursor-pointer bg-teal-600 text-white px-4 py-2 rounded-lg hover:bg-teal-700 transition-colors'
                  >
                    Choose File
                  </label>
