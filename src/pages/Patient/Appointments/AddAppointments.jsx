      ...
      >
        <div className='flex gap-6'>
          ...
          <div className='flex-1'>
            ...
            <div className='mb-3'>
              <span
                className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium ${availability.color}`}
              >
          ...
          <div className='flex items-center justify-between'>
            <div>
              ...
              <p className='text-slate-600 mt-1'>
                Search and book appointments with qualified healthcare providers
              </p>
            </div>
          </div>
        </div>
            ...
            <Form>
              ...
              <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>
                {filteredDoctors.length > 0 ? (
                  <div className='space-y-6'>{filteredDoctors.map(renderDoctorCard)}</div>
                ) : (
