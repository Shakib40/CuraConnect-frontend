...
import { Activity, Calendar as CalendarIcon, FileText, Pill } from 'lucide-react'
  ...
  return (
    <div className='p-6 max-w-7xl mx-auto space-y-6'>
      <div className='flex flex-col md:flex-row md:items-center justify-between mb-6'>
        <div>
          <h1 className='text-2xl font-bold text-slate-800'>Welcome back, Mock Patient</h1>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        <div className='bg-white p-6 rounded-xl border border-slate-200 shadow-sm'>
          <h2 className='text-lg font-semibold text-slate-800 mb-4'>Health Trends (Line Chart)</h2>
          <div className='h-64'>
        ...
        {/* Bar Chart */}
        <div className='bg-white p-6 rounded-xl border border-slate-200 shadow-sm'>
          <h2 className='text-lg font-semibold text-slate-800 mb-4'>Activity Levels (Bar Chart)</h2>
          <div className='h-64'>
