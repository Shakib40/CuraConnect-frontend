...
const mockReports = [
  {
    ...
    status: 'Normal',
    description:
      'Complete blood count test including red blood cells, white blood cells, hemoglobin, and platelets.',
    results: {
  ...
  },
  {
    ...
    findings:
      'No acute cardiopulmonary abnormalities. Lungs are clear. Heart size is normal. No pleural effusion or pneumothorax. Visualized bones are intact.',
    imaging: {
  ...
  },
  {
    ...
    status: 'Good',
    description:
      'Comprehensive annual health examination including vital signs, blood work, and physical assessment.',
    vitals: {
  ...
  },
  {
    ...
    status: 'Normal',
    description:
      'Comprehensive metabolic panel including electrolytes, kidney function, liver function, and glucose.',
    results: {
      Glucose: '92 mg/dL',
      Sodium: '140 mEq/L',
      Potassium: '4.2 mEq/L',
            ...
            <div className='bg-white rounded-lg border border-slate-200 p-6'>
              ...
              <div className='space-y-3'>
                {Object.entries(report.recommendations).map(([key, value]) => (
                  <div
                    key={key}
                    className='flex justify-between items-start py-2 border-b border-slate-100'
                  >
