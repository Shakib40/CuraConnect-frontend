...
const NotificationSetting = () => {
  ...
  const getTypeIcon = (type) => {
    switch (type) {
      ...
      case 'marketing': return AlertCircle;
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm text-slate-600">{notificationSettings.email.address}</span>
          ...
          <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm text-slate-600">{notificationSettings.sms.phoneNumber}</span>
          ...
          <div className="flex items-center justify-between p-4 border border-slate-200 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm text-slate-600">{notificationSettings.push.deviceName}</span>
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                    <CheckCircle className="w-3 h-3" />
                    Active
                  </span>
              ...
              <div>
                ...
                <div className="flex items-center gap-4 text-sm text-slate-600">
                  <span className="flex items-center gap-1">
                    {notificationSettings.inApp.sound ? <Volume2 className="w-3 h-3" /> : <VolumeX className="w-3 h-3" />}
                    Sound
                  </span>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        ...
                        {type === 'prescriptions' && 'Prescription refills and medication reminders'}
                  ...
                  <div className="space-y-3">
                    ...
                    {type === 'appointments' && (
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-slate-700 mb-1">Reminder Timing</label>
                          <select
                            value={settings.timing}
                            onChange={(e) => setNotificationTypes(prev => ({
                              ...prev,
                        ...
                        <div>
                          <label className="block text-sm font-medium text-slate-700 mb-1">Number of Reminders</label>
                          <select
                    ...
                    {type === 'prescriptions' && (
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-slate-700 mb-1">Refill Reminder</label>
                          <select
