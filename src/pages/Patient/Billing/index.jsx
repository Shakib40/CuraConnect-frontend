    ...
    <div className='p-6 mx-auto space-y-6'>
      <div className='flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6'>
        <div>
          ...
          <p className='text-slate-500 mt-1'>Manage your payments and download receipts.</p>
        </div>

        {/* Outstanding Balance Card */}
        <div className='bg-amber-50 border border-amber-200 p-4 rounded-xl flex items-center justify-between gap-6'>
          <div>
            <p className='text-amber-700 text-sm font-medium mb-1'>Total Outstanding Due</p>
            <p className='text-3xl font-bold text-amber-900'>${totalDue.toFixed(2)}</p>
          </div>
          {totalDue > 0 && (
          ...
          <div className='space-y-6'>
            <div className='flex justify-between items-center bg-slate-50 p-4 rounded-lg border border-slate-200'>
              <div>
                ...
                <p className='font-semibold text-slate-800'>{selectedInvoice.id}</p>
              </div>
            ...
            <div className='text-center p-6 border-2 border-dashed border-slate-200 rounded-xl'>
              ...
              <p className='text-slate-600 font-medium'>Stripe / PayPal Integration Placeholder</p>
