...
const WelcomePage = () => {
    ...
    const hospitalBenefits = [
        ...
        },
        {
            ...
            description: "Reduce operational costs through efficient resource management and bulk purchasing"
        },
        {
            icon: <Users className="w-8 h-8 text-blue-600" />,
    ...
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="container mx-auto px-6 py-4">
                    <div className="flex items-center justify-between w-full">
                        ...
                        <nav className="hidden md:flex items-center space-x-8">
                            ...
                            <a href="#patients" className="text-slate-600 hover:text-teal-600 transition-colors font-medium">For Patients</a>
                            <a href="#hospitals" className="text-slate-600 hover:text-teal-600 transition-colors font-medium">For Hospitals</a>
            ...
            <section id="patients" className="py-20 bg-gradient-to-br from-teal-50 to-blue-50">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-slate-800 mb-4">Why Patients Choose CuraConnect</h2>
                        <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {patientBenefits.map((benefit, index) => (
                            <div key={index} className="text-center p-6 rounded-lg bg-white hover:shadow-lg transition-all">
                                <div className="flex justify-center mb-4">
                                    {benefit.icon}
                                </div>
            ...
            <section id="hospitals" className="py-20 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-slate-800 mb-4">Why Hospitals Choose CuraConnect</h2>
                        <p className="text-lg text-slate-600 max-w-3xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {hospitalBenefits.map((benefit, index) => (
                            <div key={index} className="text-center p-6 rounded-lg border border-slate-200 hover:border-orange-500 hover:shadow-lg transition-all">
                                <div className="flex justify-center mb-4">
                                    {benefit.icon}
                                </div>
                                <h3 className="text-xl font-semibold text-slate-800 mb-2">{benefit.title}</h3>
            ...
            <section id="suppliers" className="py-20 bg-gradient-to-br from-yellow-50 to-orange-50">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-slate-800 mb-4">Why Suppliers Choose CuraConnect</h2>
                        <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            ...
            <section id="testimonials" className="relative min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
                {/* Background Pattern */}
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-center">
                        <div className="mb-8">
                            ...
                            <h2 className="text-4xl font-bold text-white mb-4">Stay Connected with CuraConnect</h2>
