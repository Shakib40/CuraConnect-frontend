...
const ChatPage = () => {
    ...
    () => ({
      'chat-001': [
        ...
        },
        {
          id: 'msg-002',
          sender: 'me',
          content: 'I can help with that. How many units do you need?',
          timestamp: '10:32 AM',
          status: 'delivered',
        },
        {
          id: 'msg-003',
          sender: 'other',
          content: 'We need approximately 10,000 units by next week',
          timestamp: '10:35 AM',
          status: 'delivered',
        },
        {
          id: 'msg-004',
          sender: 'me',
          content: "That's definitely manageable. I can prepare that order for you.",
          timestamp: '10:37 AM',
          status: 'delivered',
        },
        {
  ...
  const messagesMemo = useMemo(() => mockMessages[selectedChat] || [], [mockMessages, selectedChat])
