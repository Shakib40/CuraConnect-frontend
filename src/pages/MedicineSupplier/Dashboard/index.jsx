...
const MedicineSupplierDashboard = () => {
    // Mock Data
    const stats = [
        { label: "Total Products", value: "1,245", icon: Package, color: "text-purple-600", bg: "bg-purple-50" },
        { label: "Active Orders", value: "89", icon: ShoppingCart, color: "text-blue-600", bg: "bg-blue-50" },
        { label: "Total Revenue", value: "$45,280", icon: DollarSign, color: "text-green-600", bg: "bg-green-50" },
        { label: "Growth Rate", value: "+12.5%", icon: TrendingUp, color: "text-orange-600", bg: "bg-orange-50" },
    ];
