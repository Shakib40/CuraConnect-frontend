...
const SettingsPage = () => {
  ...
  const [generalSettings, setGeneralSettings] = useState({
    ...
    aboutMe:
      'Leading medical supply company with 10+ years of experience in pharmaceutical distribution and healthcare equipment supply.',
  ...
  const tabs = [
    ...
    },
    {
      ...
      component: (
        <DocumentsSettings
          ...
          setDocumentsSettings={setDocumentsSettings}
        />
      ),
    },
    {
      ...
      component: (
        <BankDetailsSettings
          bankDetailsSettings={bankDetailsSettings}
          setBankDetailsSettings={setBankDetailsSettings}
        />
      ),
    },
    {
    ...
    },
    {
      ...
      icon: <Settings className='w-4 h-4' />,
      component: (
        <OthersSettings othersSettings={othersSettings} setOthersSettings={setOthersSettings} />
      ),
    },
  ]
