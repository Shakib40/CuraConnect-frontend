...
import { Building, Package, Calendar, MapPin, Phone, Plus, User, Upload, Trash2 } from "lucide-react";
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <Input
                        ...
                        onChange={(e) => setGeneralSettings({...generalSettings, companyLogo: e.target.value})}
                ...
                <div>
                    <Input
                        ...
                        onChange={(e) => setGeneralSettings({...generalSettings, businessRegistration: e.target.value})}
                ...
                <div>
                    <Select
                        ...
                        onChange={(e) => setGeneralSettings({...generalSettings, industryType: e.target.value})}
                        label="Industry Type"
                        options={[
            ...
            <div className="space-y-4">
                <ToggleCheckbox
                    ...
                    onChange={(e) => setGeneralSettings({...generalSettings, supplyStatus: e.target.checked ? 'active' : 'on-hold'})}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    <Select
                        ...
                        onChange={(e) => setGeneralSettings({...generalSettings, reportsFrequency: e.target.value})}
                ...
                <div>
                    <Input
                        ...
                        onChange={(e) => setGeneralSettings({...generalSettings, reportsStartDate: e.target.value})}
                        label="Start Date"
                    />
                </div>
                <div>
                    <Input
                        ...
                        onChange={(e) => setGeneralSettings({...generalSettings, reportsEndDate: e.target.value})}
                        label="End Date"
                    />
                </div>
            </div>
