      ...
      <div className='space-y-4'>
        <div>
          <Input
            ...
            onChange={(e) =>
              setOthersSettings({ ...othersSettings, emergencyContactName: e.target.value })
            }
        ...
        <div>
          <Input
            ...
            onChange={(e) =>
              setOthersSettings({ ...othersSettings, emergencyContactPhone: e.target.value })
            }
        ...
        <div>
          <Input
            ...
            onChange={(e) =>
              setOthersSettings({ ...othersSettings, emergencyContactEmail: e.target.value })
            }
