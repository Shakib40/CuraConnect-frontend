...
const BankDetailsSettings = ({ bankDetailsSettings, setBankDetailsSettings }) => {
  ...
  const handleAddBankAccount = () => {
    const newAccounts = [
      ...(bankDetailsSettings.bankAccounts || []),
      {
        id: Date.now(),
        accountName: '',
        accountNumber: '',
        ...
        <div className='space-y-4'>
          <div>
            <Select
              ...
              onChange={(e) =>
                setBankDetailsSettings({ ...bankDetailsSettings, paymentGateway: e.target.value })
              }
          ...
          <ToggleCheckbox
            ...
            onChange={(e) =>
              setBankDetailsSettings({ ...bankDetailsSettings, autoSettlement: e.target.checked })
            }
      ...
      <div className='border-t pt-6'>
        ...
        <div className='space-y-4'>
          <ToggleCheckbox
            ...
            onChange={(e) =>
              setBankDetailsSettings({ ...bankDetailsSettings, twoFactorAuth: e.target.checked })
            }
