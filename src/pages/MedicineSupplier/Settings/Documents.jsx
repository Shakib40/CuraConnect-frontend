                ...
                {documentsSettings.documents
                  ...
                  .map((doc) => (
                    <tr key={doc.id} className='border-b hover:bg-slate-50'>
                      ...
                      <td className='p-3 text-slate-600'>{doc.expiryDate || 'Not set'}</td>
                      <td className='p-3 text-slate-600 text-sm'>{doc.fileName || 'Unknown'}</td>
                      <td className='p-3'>
      ...
      <div className='border-t pt-6'>
        ...
        <div className='space-y-4'>
          <ToggleCheckbox
            ...
            onChange={(e) =>
              setDocumentsSettings({ ...documentsSettings, autoReminders: e.target.checked })
            }
          ...
          <div>
            <Select
              ...
              onChange={(e) =>
                setDocumentsSettings({ ...documentsSettings, reminderDays: e.target.value })
              }
