  ...
  const [notes, setNotes] = useState([
    {
      ...
      description:
        'Follow up with Metro Medical Center regarding the billing dispute case. Need to ensure all documentation is properly filed.',
    ...
    },
    {
      ...
      description:
        'Review MediCare Pharmaceuticals contract for Q2 2024. Focus on delivery timelines and quality standards.',
    ...
    },
    {
      ...
      description:
        'HealthGuard Insurance policy changes need to be reviewed by end of week. Check coverage for telemedicine services.',
