...
const variants = {
    ...
    outline: "bg-transparent border border-border text-text-muted hover:bg-surface-muted hover:text-text-main",
...
const Button = ({
    ...
    const baseClasses = "inline-flex items-center justify-center font-bold tracking-tight rounded-xl transition-all active:scale-95 disabled:opacity-60 disabled:pointer-events-none disabled:scale-100";
