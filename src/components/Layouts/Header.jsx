      ...
      <div className='flex items-center gap-4'>
        ...
        <div className='relative'>
          ...
          {showNotifications && (
            <div
              ref={notificationRef}
              className='absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-slate-200 z-[60]'
            >
        ...
        <div className='relative'>
          ...
          {showProfileMenu && (
            <div
              ref={profileRef}
              className='absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-slate-100 py-2 py-1 z-50'
            >
